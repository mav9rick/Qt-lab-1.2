...
void win::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->infS((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (win::*)(int );
            if (_t _q_method = &win::infS; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
